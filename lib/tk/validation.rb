...
module TkValidation
  ...
  # validatecommand/invalidcommand/vcmd/invcmd accessors are generated by
  # OptionDSL (type: :callback). Do not define them here — it conflicts
  # with accessor generation.
end
