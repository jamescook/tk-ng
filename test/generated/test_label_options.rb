...
# Auto-generated option accessor tests for TkLabel
...
class TestGeneratedLabelOptions < Minitest::Test
  include TkTestHelper

  def test_label_accessors
    assert_tk_app("Label accessor tests", method(:label_accessors_app))
  end
